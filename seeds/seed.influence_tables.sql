...
INSERT INTO influence_users (user_name, full_name, nickname, password)
VALUES
  ...
  ('Lucho2027', 'Luis Rodriguez', 'Lucho', '123456');

INSERT INTO influence_workouts (title, author_id, content)
VALUES
  ('First post!', 1,
...
INSERT INTO influence_comments (
  text,
  workout_id,
  user_id
) VALUES
